...
'\n' +
'  <div class="alert appear" ng-class="\'alert-\' + feedback.type" ng-if="feedback">\n' +
...
'      <p>We have found {{ assertionImport.length }} asserertions that can be inserted into the evaluation audit results</p>\n' +
'\n' +
'      <fieldset>\n' +
...
'      <h2>Step 3 - Finalize import</h2>\n' +
'      <p>Imported {{ assertionImport.length }} asserertions and inserted to the audit results.</p>\n' +
'\n' +
